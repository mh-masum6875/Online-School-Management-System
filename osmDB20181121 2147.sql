...
INSERT INTO `notice` (`n_id`,`n_title`,`n_description`,`publish_date`) VALUES 
 (1,'Class Six Admission Circular - 2021','ssss dddd aaaa','2021-10-10'),
 (2,'XII 2021-2022 Fees Notice ( Aug to Oct 2021)','aaasss ddf gghy ddrr ggjjbb ddefr vggth cdffr bmjbh hhg ','2021-10-28'),
 (3,'School Departure time for junior section has been changed','Dear Parents, School Departure time for junior section has been changed from Main Campus From November 01, 2020 until further notice.','2021-11-02');
...
INSERT INTO `student_info` (`s_id`,`s_name`,`c_id`,`sess_id`,`roll_no`,`gender`,`dob`,`age`,`f_name`,`m_name`,`telephone_no`,`mobile_no`,`present_address`,`permanent_address`) VALUES 
 (1,'Mohammad Bin Afsar',1,1,6001,'Male','2007-11-14',11,'Nurul Afsar','Aleya Begum',1671315561,1671315561,'Taman U','Skudai'),
 (2,'Salman Samir',1,1,6002,'Male','2006-11-14',12,'Saiful Islam','Fahmida Akhter',1671315561,1671541268,'UTM','Johor'),
 (3,'Lubaba Tabassum',3,1,8001,'Female','2004-11-14',14,'Md. Alauddin','Khaleda Akhtar',1811375624,1811375624,'Badda, Dhaka','Narayanganj'),
 (4,'Abir Sharier',1,1,6003,'Male','2005-11-14',11,'Sakhawat Hosen','Mahmuda Akhtar',1671658294,1671658294,'Kl','Bukit Bentang'),
 (5,'Najiba Akhtar',2,1,7001,'Female','2006-11-14',12,'Md. Alauddin','Khaleda Akhtar',181452268,181452268,'UTHM','Patu Bahat');
...
INSERT INTO `teacher_info` (`t_id`,`t_name`,`t_email`,`gender`,`phone_number`,`address`,`sub_id`,`join_date`) VALUES 
 (1,'Rafiq Uddin','rafiquddin100@gmail.com','Male',1671315565,'Mirpur',1,'2022-2-1'),
 (6,'aaa','aaa@gmail.com','Female',1671315561,'Pahartali',2,'2022-2-8');
