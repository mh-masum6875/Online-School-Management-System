            ...
            <div class="row">
                ...
                <div class="col-7 col-sm-12 col-md-7">
                    ...
                    <div class="container border rounded">
                        ...
                        <hr/>
                        <p align="justify" style="text-indent: 30px;margin-left: 30px;margin-right: 30px;line-height: 1.5em;"> We are UTM Students from Internet programming Section 4 and doing Internet programming project. <br/></p>
